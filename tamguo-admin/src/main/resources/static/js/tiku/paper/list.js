	...
	methods: {
		...
		del: function (event) {
			...
			confirm('确定要删除选中的记录？', function(){
				$.ajax({
					type: "POST",
				    url: mainHttp + "paper/delete.html",
		...
		saveOrUpdate: function (event) {
			var url = vm.paper.uid == null ? mainHttp + "paper/save.html" : mainHttp + "paper/update.html";
			$.ajax({
				type: "POST",
			    url: url,
		...
		getCouseList: function(){
			return axios.get(mainHttp + "course/findBySubjectId.html?subjectId="+vm.paper.subjectId);
		},
		...
		getAreaList:function(){
			return axios.get(mainHttp + "area/getArea.html");
		},
		getPaper:function(paperId){
			return axios.get(mainHttp + "paper/info/"+paperId+".html");
		}
	},
	watch:{
		  // 数据修改时触发
