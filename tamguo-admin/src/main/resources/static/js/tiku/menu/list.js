...
var vm = new Vue({
	...
	methods: {
		getMenu: function(menuId){
			//加载菜单树
			$.get(mainHttp + "menu/getMenuTree.html", function(r){
		...
		update: function (event) {
			...
			$.ajax({
				type : "get", 
				url : mainHttp + "menu/info/"+menuId+".html",
				async : true,
				dataType : "json",
		...
		saveOrUpdate: function (event) {
			var url = vm.menu.uid == null ? mainHttp + "menu/save.html" : mainHttp + "menu/update.html";
			$.ajax({
				type: "POST",
			    url: url,
