...
var vm = new Vue({
	...
	methods: {
		...
		getMenu: function(courseId){
			//加载菜单树
			return axios.get(mainHttp + "course/getChapterTree/"+courseId+".html");
		},
		...
		getCourse:function(courseId){
			return axios.get(mainHttp + "course/info/"+courseId+".html");
		},
		del: function (event) {
		...
		saveOrUpdate: function (event) {
			var url = vm.course.uid == null ? mainHttp + "course/save.html" : mainHttp + "course/update.html";
			// 获取章节
