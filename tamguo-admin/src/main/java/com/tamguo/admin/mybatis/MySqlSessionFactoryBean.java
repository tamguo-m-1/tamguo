package com.tamguo.admin.mybatis;
...
import com.tamguo.admin.mybatis.handler.ColumnHandler;
import com.tamguo.admin.mybatis.handler.ConditionHandler;
import com.tamguo.admin.mybatis.handler.DeleteByConditionHandler;
import com.tamguo.admin.mybatis.handler.DeleteByIdsHandler;
import com.tamguo.admin.mybatis.handler.DeleteHandler;
import com.tamguo.admin.mybatis.handler.InsertHandler;
import com.tamguo.admin.mybatis.handler.ResultMapHandler;
import com.tamguo.admin.mybatis.handler.SelectAllHandler;
import com.tamguo.admin.mybatis.handler.SelectByConditionHandler;
import com.tamguo.admin.mybatis.handler.SelectByEntityHandler;
import com.tamguo.admin.mybatis.handler.SelectByIdsHandler;
import com.tamguo.admin.mybatis.handler.SelectByPageHandler;
import com.tamguo.admin.mybatis.handler.SelectHandler;
import com.tamguo.admin.mybatis.handler.UpdateByConditionHandler;
import com.tamguo.admin.mybatis.handler.UpdateHandler;
...
public class MySqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
	...
	private String getEntityFullName(Element element) {
		...
		// 浠ラ厤缃寘寮�澶村苟浠ラ厤缃悗缂�缁撳熬鐨勮В鏋愶紝鍏朵粬鐨勪笉瑙ｆ瀽锛堜负浜嗗吋瀹瑰凡鏈夌殑锛�
