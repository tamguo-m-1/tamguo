...
CREATE TABLE `sys_menu` (
  `uid` varchar(64) NOT NULL COMMENT 'ID',
  `company_id` varchar(20) NOT NULL DEFAULT '0' COMMENT '所属公司',
  `parent_id` varchar(20) NOT NULL DEFAULT '0' COMMENT '父ID',
  `name` varchar(100) NOT NULL DEFAULT '' COMMENT '名稱',
  `url` varchar(255) NOT NULL DEFAULT '' COMMENT 'URL',
  `type` varchar(255) NOT NULL DEFAULT '' COMMENT '菜單類型',
  `order_num` int(11) NOT NULL DEFAULT '0' COMMENT '排序',
  `perms` varchar(200) NOT NULL DEFAULT '' COMMENT '授权ID',
  PRIMARY KEY (`uid`)
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES ('2', '0', '1', '菜单管理', 'sys/menu.html', '1', '1', 'sys:menu:save,sys:menu:update,sys:menu:delete');
INSERT INTO `sys_menu` VALUES ('3', '0', '1', '用户管理', 'sys/user.html', '1', '2', 'sys:user:list,sys:user:save,sys:user:update,sys:user:delete');
INSERT INTO `sys_menu` VALUES ('1', '0', '0', '系统管理', '', '0', '1', '');
INSERT INTO `sys_menu` VALUES ('4', '0', '1', '角色管理', 'sys/role.html', '1', '3', 'sys:role:save,sys:role:update,sys:role:delete');
INSERT INTO `sys_menu` VALUES ('1007110020174102530', '0', '0', '内容管理', '', '0', '1', '');
INSERT INTO `sys_menu` VALUES ('1007110181935824897', '0', '1007110020174102530', '考试类型', 'tiku/subject/list.html', '1', '1', 'tiku:subject:list,tiku:subject:create,tiku:subject:edit,tiku:subject:delete');
INSERT INTO `sys_menu` VALUES ('1007131624149020674', '0', '1007110020174102530', '科目管理', 'tiku/course/list.html', '1', '0', 'tiku:course:save,tiku:course:update,tiku:course:delete,tiku:course:list');
INSERT INTO `sys_menu` VALUES ('1007131812368412674', '0', '1007110020174102530', '菜单管理', 'tiku/menu/list.html', '1', '0', 'tiku:menu:list,tiku:menu:save,tiku:menu:update,tiku:menu:delete');
INSERT INTO `sys_menu` VALUES ('1007131944577069057', '0', '1007110020174102530', '试卷管理', 'tiku/paper/list.html', '1', '0', 'tiku:paper:list,tiku:paper:save,tiku:paper:update,tiku:paper:delete');
INSERT INTO `sys_menu` VALUES ('1007132369439092738', '0', '1007110020174102530', '试题管理', 'tiku/question/list.html', '1', '0', 'tiku:question:list,tiku:question:save,tiku:question:update,tiku:question:delete,tiku:question:audit,tiku:question:notAudit');
...
CREATE TABLE `sys_role` (
  ...
  `perms` varchar(255) NOT NULL DEFAULT '' COMMENT '權限(模塊:功能:操作)',
  PRIMARY KEY (`uid`)
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1', '管理员', '1,2,3,4,1007110020174102530,1007131624149020674,1007131812368412674,1007131944577069057,1007132369439092738,1007110181935824897');
INSERT INTO `sys_role` VALUES ('2', '员工', '1,2,3,4');
INSERT INTO `sys_role` VALUES ('3', '其他管理员', '1,2,3,4');
...
CREATE TABLE `sys_user` (
  `uid` varchar(64) NOT NULL COMMENT 'ID',
  `user_name` varchar(100) NOT NULL DEFAULT '' COMMENT '名稱',
  `nick_name` varchar(100) NOT NULL DEFAULT '' COMMENT '昵称',
  `mobile` varchar(20) NOT NULL DEFAULT '' COMMENT '手机号',
  `email` varchar(100) NOT NULL DEFAULT '' COMMENT '邮箱',
  `role_ids` varchar(100) NOT NULL DEFAULT '' COMMENT '用戶角色',
  `password` varchar(64) NOT NULL DEFAULT '' COMMENT '密碼',
  `status` varchar(20) NOT NULL DEFAULT 'normal' COMMENT '状态(locked:锁定，normal：正常)',
  `safe_key_value` varchar(255) NOT NULL DEFAULT '' COMMENT '安全KEY',
  `create_time` bigint(20) NOT NULL,
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=1004672654150889485 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', 'tamguo', '15618901079', 'smiletocandy@qq.com', '1', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', 'normal', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', '0');
...
-- Records of tiku_ad
-- ----------------------------
INSERT INTO `tiku_ad` VALUES ('1', 'indexBanner', '首页轮播', '[{bgimage:\"https://tangoguo.oss-cn-shanghai.aliyuncs.com/openresources/tamguo/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20180604092307.jpg\",type:1,index:2,href:\"http://www.tamguo.com\"}]');
INSERT INTO `tiku_ad` VALUES ('2', 'subject_13', '高考轮播', '[{bgimage:\"https://tangoguo.oss-cn-shanghai.aliyuncs.com/openresources/tamguo/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20180604092307.jpg\",type:1,index:2,href:\"http://www.tamguo.com\"}]');
...
INSERT INTO `tiku_chapter` VALUES ('71', '2', '70', '1.1 集合的含义', '3', '0', '0');
...
CREATE TABLE `tiku_member` (
  ...
  `paper_num` int(11) NOT NULL DEFAULT '0' COMMENT '试卷数量',
  `question_num` int(11) NOT NULL DEFAULT '0' COMMENT '问题数量',
  `down_num` int(11) NOT NULL DEFAULT '0' COMMENT '下载次数',
  `hits_num` int(11) NOT NULL DEFAULT '0' COMMENT '查阅次数',
  PRIMARY KEY (`uid`)
...
-- ----------------------------
INSERT INTO `tiku_member` VALUES ('12', 'tamguo', 'tamguo', 'd51a70df396d0d6c0aca3cd4e08883fc2b586e2121ca3e65128180961ae092d7', 'files/20180613/MTX00001.png', '15618910786', 'candy.tam@aliyun.com', '1000', '21.00', '1529026698', '0', '0', '0', '0');
...
-- ----------------------------
INSERT INTO `tiku_paper` VALUES ('15', '13', '5', '0', '1', '12', '物理 丰台区2017年高三第二次模拟考试', '[{\"uid\":1,\"name\":\"单选题\",\"title\":\"单选题\",\"type\":\"1\"},{\"uid\":2,\"name\":\"单选题\",\"title\":\"23123\",\"type\":\"1\"}]', '0', '2017', '0', '0', '物理 丰台区2017年高三第二次模拟考试', '物理 丰台区2017年高三第二次模拟考试', '物理 丰台区2017年高三第二次模拟考试');
INSERT INTO `tiku_paper` VALUES ('16', '0', '0', '0', '1', '12', '测试试卷', '[]', '0', '', '0', '0', '测试试卷', '测试试卷', '测试试卷');
INSERT INTO `tiku_paper` VALUES ('17', '0', '2', '1', '1', '12', '试卷名称', '[]', '0', '2017', '0', '0', '试卷名称', '试卷名称', '试卷名称');
INSERT INTO `tiku_paper` VALUES ('18', '13', '2', '1', '1', '12', '试卷名称1', '[]', '0', '2017', '0', '0', '试卷名称', '试卷名称', '试卷名称');
INSERT INTO `tiku_paper` VALUES ('19', '0', '2', '1', '1', '12', '试卷名称1', '[]', '0', '2017', '0', '0', '试卷名称', '试卷名称', '试卷名称');
INSERT INTO `tiku_paper` VALUES ('20', '0', '2', '1', '1', '12', '试卷名称1', '[]', '0', '2017', '0', '0', '试卷名称', '试卷名称', '试卷名称');
INSERT INTO `tiku_paper` VALUES ('21', '13', '5', '0', '1', '12', '物理 丰台区2017年高三第二次模拟考试', '[{\"uid\":1,\"name\":\"单选题\",\"title\":\"单选题\",\"type\":\"1\"}]', '0', '2017', '0', '0', '物理 丰台区2017年高三第二次模拟考试', '物理 丰台区2017年高三第二次模拟考试', '物理 丰台区2017年高三第二次模拟考试');
INSERT INTO `tiku_paper` VALUES ('22', '13', '5', '0', '1', '12', '物理 丰台区2017年高三第二次模拟考试', '[{\"uid\":1,\"name\":\"单选题\",\"title\":\"单选题\",\"type\":\"1\"}]', '0', '2017', '0', '0', '物理 丰台区2017年高三第二次模拟考试', '物理 丰台区2017年高三第二次模拟考试', '物理 丰台区2017年高三第二次模拟考试');
INSERT INTO `tiku_paper` VALUES ('23', '13', '5', '0', '1', '12', '物理 丰台区2017年高三第二次模拟考试', '[{\"uid\":1,\"name\":\"单选题\",\"title\":\"单选题\",\"type\":\"1\"}]', '0', '2017', '0', '0', '物理 丰台区2017年高三第二次模拟考试', '物理 丰台区2017年高三第二次模拟考试', '物理 丰台区2017年高三第二次模拟考试');
INSERT INTO `tiku_paper` VALUES ('24', '13', '5', '0', '1', '12', '物理 丰台区2017年高三第二次模拟考试', '[{\"uid\":1,\"name\":\"单选题\",\"title\":\"单选题\",\"type\":\"1\"}]', '0', '2017', '0', '0', '物理 丰台区2017年高三第二次模拟考试', '物理 丰台区2017年高三第二次模拟考试', '物理 丰台区2017年高三第二次模拟考试');
INSERT INTO `tiku_paper` VALUES ('25', '13', '5', '0', '1', '12', '物理 丰台区2017年高三第二次模拟考试', '[{\"uid\":1,\"name\":\"单选题\",\"title\":\"单选题\",\"type\":\"1\"}]', '0', '2017', '0', '0', '物理 丰台区2017年高三第二次模拟考试', '物理 丰台区2017年高三第二次模拟考试', '物理 丰台区2017年高三第二次模拟考试');
...
INSERT INTO `tiku_question` VALUES ('1006829001063776258', '1', '0', '5', '0', '25', '<p>123123</p>', '<p>123123</p>', '<p>123213</p>', '123', '123', '123', '1');
INSERT INTO `tiku_question` VALUES ('1006829541315297282', '1', '0', '5', '0', '25', '<p>23123</p>', '<p>1231</p>', '<p>123123</p>', '123', '123', '123', '1');
INSERT INTO `tiku_question` VALUES ('1006829942856990721', '1', '0', '5', '0', '25', '<p>123123</p>', '<p>123123</p>', '<p>123</p>', '123123', '3123', '123', '1');
INSERT INTO `tiku_question` VALUES ('1006829950964580354', '1', '0', '5', '0', '25', '<p>123123</p>', '<p>123123</p>', '<p>123</p>', '123123', '3123', '123', '1');
INSERT INTO `tiku_question` VALUES ('1006830088680357890', '1', '0', '5', '0', '25', '<p>12312</p>', '<p>3123</p>', '<p>123123</p>', '123', '123', '123', '1');
INSERT INTO `tiku_question` VALUES ('1006830349725450242', '1', '0', '5', '0', '25', '<p>123123</p>', '<p>1231</p>', '<p>23123123</p>', '123', '123', '123', '1');
INSERT INTO `tiku_question` VALUES ('1007162646974644226', '1', '0', '5', '0', '21', '<p>123</p>', '<p>123</p>', '<p>123</p>', '123123', '123', '123', '');
...
-- ----------------------------
-- Table structure for tiku_teacher
-- ----------------------------
DROP TABLE IF EXISTS `tiku_teacher`;
CREATE TABLE `tiku_teacher` (
  `uid` varchar(64) NOT NULL DEFAULT '' COMMENT 'ID',
  `mobile` varchar(20) NOT NULL DEFAULT '' COMMENT '手机号',
  `name` varchar(20) NOT NULL DEFAULT '' COMMENT '姓名',
  `motto` varchar(255) NOT NULL DEFAULT '' COMMENT '座右铭',
  `area_id` varchar(64) NOT NULL DEFAULT '' COMMENT '地区',
  `course_id` varchar(64) NOT NULL DEFAULT '' COMMENT '科目',
  `school_id` varchar(64) NOT NULL DEFAULT '' COMMENT '学校',
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tiku_teacher
-- ----------------------------
